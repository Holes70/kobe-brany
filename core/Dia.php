...
class Dia {
  ...
  public function autoload() {
    spl_autoload_register(function ($class_name) {
      ...
      if (file_exists($this->config['dir']['root']. '/core/classes/' . $class_name . '.php')) {
        require_once 'core/classes/' . $class_name . '.php';
      } else if (file_exists($this->config['dir']['root']. '/core/components/' . reset($parts) . '.php')) {
        require_once 'core/components/' . reset($parts) . '.php';
      }
    });
  }
