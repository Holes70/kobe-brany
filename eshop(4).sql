...
--
-- Host: localhost
-- Generation Time: Dec 05, 2021 at 11:09 PM
...
(2, 'products', '{\"id\":{\"type\":\"number\",\"show_in_table\":false,\"show_in_form\":false},\"name\":{\"show_in_table\":true,\"name_in_table\":\"Produkt\",\"show_in_form\":true},\"image\":{\"type\":\"image\",\"show_in_table\":true,\"show_in_form\":true},\"description\":{\"type\":\"text\",\"show_in_table\":true,\"name_in_table\":\"Popis\",\"show_in_form\":true},\"price\":{\"type\":\"number\",\"show_in_table\":true,\"name_in_table\":\"Cena\",\"show_in_form\":true}}');
...
INSERT INTO `products` (`id`, `name`, `image`, `description`, `price`, `id_product_info`, `id_product_accessories`) VALUES
(2, 'Product_54', 'default.png', 'Popis', 0.00, 1, 1),
(3, 'Product_29f', NULL, 'Popis', 14.00, 3, 5),
(4, 'Product_97', NULL, 'Popis', 0.00, 5, 1),
(5, 'Product_20', NULL, 'Popis', 0.00, 1, 3);
