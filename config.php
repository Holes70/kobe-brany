<?php
  ...
  $config['head']['css']        = ['sweetalert.css', /*'materialize.css'*/ 'style4.css', 'notfound.css', 'gallery.css', 'lightbox.css'];
  $config['head']['script']     = ['sweetalert.js', 'jquery.js', 'main.js', 'gallery.js', 'fancybox.js'/*'materialize.js'*/];
